...
- NielsenIQ 2022 consumer recall response survey — 68% brand-abandonment finding. The primary NielsenIQ report is not publicly archived (report on file); the figure is publicly attributed to the survey in trade-press coverage including Food Dive's recall coverage.
