...
- [FDA recall enforcement data — openFDA Food Enforcement API](https://open.fda.gov/apis/food/enforcement/) — public access to the FDA Recall Enterprise System (RES) covering recall event information from 2004 to present, updated weekly. This is the programmatic interface to what is informally called the "FDA Enforcement Reports database."
...
- NielsenIQ 2022 consumer recall response survey — 68% brand-abandonment finding. The primary NielsenIQ report is not publicly archived; the figure is publicly attributed to the survey in [Food Dive's recall coverage](https://web.archive.org/web/2025/https://www.fooddive.com/spons/food-recalls-have-increased-over-20-what-is-your-business-doing-about-it/739253/) (linked via Internet Archive Wayback Machine, since Food Dive's site blocks automated link-checking but the Archive snapshot is stable and lychee-friendly).
...
- Mérieux NutriSciences, ["Food Industry Highlights" bi-monthly report hub](https://na.mxns.com/regulatory/food-industry-highlights) — source for the Q1 2025 foreign-material-contamination 93% YoY trend (specific bi-monthly report behind a download form on this hub page).
